...
// 获取壁纸总数用于分页
$totalWallpapers = getTotalWallpapers($conn, 'desktop');
$totalPages = ceil($totalWallpapers / $perPage);

// 使用已存在的getWallpapers函数
$wallpapers = getWallpapers($conn, 'desktop', $perPage, $offset);
...
<body class=""> 
    ...
    <div class="wallpaper-container">
        ...
        <div class="pagination">
            <?php if ($page > 1): ?>
                <a href="?type=desktop&page=1"><i class="fas fa-angle-double-left"></i></a>
                <a href="?type=desktop&page=<?php echo $page - 1; ?>"><i class="fas fa-angle-left"></i></a>
            <?php endif; ?>
            ...
            ?>
                <a href="?type=desktop&page=<?php echo $i; ?>" class="<?php echo ($i == $page) ? 'active' : ''; ?>">
                    <?php echo $i; ?>
                </a>
            <?php endfor; ?>
        
            <?php if ($page < $totalPages): ?>
                <a href="?type=desktop&page=<?php echo $page + 1; ?>"><i class="fas fa-angle-right"></i></a>
                <a href="?type=desktop&page=<?php echo $totalPages; ?>"><i class="fas fa-angle-double-right"></i></a>
            <?php endif; ?>
